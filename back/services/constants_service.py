...
def get_prediction_model_endpoint_key() -> str:
    """
    Return the accepted input key of the model endpoint
    :return: the accepted input key of the model endpoint
    """
    return get_analyzer_endpoint_key()


def get_max_input_length() -> int:
    """
    Return the max accepted length for an input from which the endpoint will return the toxicity statistics.
...
def get_analyzer_endpoint_host_env_variable_label() -> str:
    """
    Return the label of the analyzer endpoint host environment variable used by the api.
    :return: the label of the analyzer endpoint host environment variable used by the api.
    """
    return 'ANALYZER_ENDPOINT_HOST'
...
def get_analyzer_model_host_env_variable_label() -> str:
    """
    Return the label of the prediction model host environment variable used by the api.
    :return: the label of the prediction model host environment variable used by the api.
    """
    return 'ANALYZER_RUN_HOST'


def get_analyzer_model_port_env_variable_label() -> str:
    """
    Return the label of the prediction model port environment variable used by the api.
    :return: the label of the prediction model port environment variable used by the api.
    """
    return 'FLASK_RUN_PORT'


def get_analyzer_endpoint_port_env_variable_label() -> str:
    """
    Return the label of the analyzer endpoint port environment variable used by the api.
    :return: the label of the analyzer endpoint port environment variable used by the api.
    """
    return 'ANALYZER_ENDPOINT_PORT'
...
def get_prediction_endpoint_url_prefix() -> str:
    """
    Return the response content key associated with any Flask Response from the analyzer.
    :return: the response message key
    """
    return 'content'


def get_prediction_model_response_content_key() -> str:
    """
    Return the response content key associated with any Flask Response from the prediction model.
    :return: the response message key
    """
    return 'content'
