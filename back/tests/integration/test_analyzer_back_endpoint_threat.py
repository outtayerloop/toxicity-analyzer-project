...
class TestAnalyzerBackEndpointThreat(BaseAnalyzerEndpointTest):
    ...
    def _get_user_input_actual_threat_rate(self, user_input: str) -> float:
        ...
        :return: the threat percentage given by the prediction endpoint from the provided user input.
        """
        threatening_content = {ct.get_analyzer_endpoint_key(): user_input}
        actual_body = super().get_analyzer_endpoint_response_body(threatening_content, True)
