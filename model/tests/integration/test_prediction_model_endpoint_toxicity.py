...
class TestPredictionModelEndpointToxicity(BasePredictionEndpointTest):
    ...
    def _get_user_input_actual_toxicity(self, user_input: str) -> float:
        ...
        :return: the toxicity percentage given by the prediction endpoint from the provided user input.
        """
        toxic_content = {ct.get_prediction_endpoint_key(): user_input}
        actual_body = super().get_prediction_endpoint_response_body(toxic_content, True)
