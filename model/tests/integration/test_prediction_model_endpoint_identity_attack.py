...
class TestPredictionModelEndpointIdentityAttack(BasePredictionEndpointTest):
    ...
    def _get_user_input_actual_identity_attack(self, user_input: str) -> float:
        ...
        :return: the identity attack percentage given by the prediction endpoint from the provided user input.
        """
        identity_attack_content = {ct.get_prediction_endpoint_key(): user_input}
        actual_body = super().get_prediction_endpoint_response_body(identity_attack_content, True)
