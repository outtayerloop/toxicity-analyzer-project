...
class TestPredictionModelEndpointInsult(BasePredictionEndpointTest):
    ...
    def _get_user_input_actual_insult_rate(self, user_input: str) -> float:
        ...
        :return: the insult percentage given by the prediction endpoint from the provided user input.
        """
        insult_content = {ct.get_prediction_endpoint_key(): user_input}
        actual_body = super().get_prediction_endpoint_response_body(insult_content, True)
