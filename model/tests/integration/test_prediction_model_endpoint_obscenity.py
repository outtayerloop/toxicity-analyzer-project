...
class TestPredictionModelEndpointObscenity(BasePredictionEndpointTest):
    ...
    def _get_user_input_actual_obscenity(self, user_input: str) -> float:
        ...
        :return: the obscenity percentage given by the prediction endpoint from the provided user input.
        """
        obscene_content = {ct.get_prediction_endpoint_key(): user_input}
        actual_body = super().get_prediction_endpoint_response_body(obscene_content, True)
