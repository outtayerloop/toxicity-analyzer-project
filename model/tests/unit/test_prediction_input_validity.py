...
class TestPredictionInputValidity:
    ...
    def test_none_request_json_returns_none_json_request_body_validity(self):
        """
        Test if the PredictionRequestValidity value returned by the corresponding method of the request validity service
        is NONE_JSON_REQUEST_BODY when the provided input is None.
        """
        expected_validity = PredictionRequestValidity.NONE_JSON_REQUEST_BODY
        invalid_request_json = None
        actual_validity = req.get_prediction_request_validity(invalid_request_json)
    ...
    def test_no_request_json_input_key_returns_missing_input_key(self):
        ...
        """
        expected_validity = PredictionRequestValidity.MISSING_INPUT_KEY
    ...
    def test_none_request_json_input_value_returns_none_input_key(self):
        ...
        """
        expected_validity = PredictionRequestValidity.NONE_INPUT_KEY
    ...
    def test_too_big_input_returns_too_big_input(self):
        ...
        """
        expected_validity = PredictionRequestValidity.TOO_BIG_INPUT
        input_key = ct.get_prediction_endpoint_key()
    ...
    def test_valid_input_returns_valid(self):
        ...
        """
        expected_validity = PredictionRequestValidity.VALID
        input_key = ct.get_prediction_endpoint_key()
        valid_input = 'x' * ct.get_max_input_length()
        valid_request_json = {input_key: valid_input}
        actual_validity = req.get_prediction_request_validity(valid_request_json)
        assert actual_validity is expected_validity
    ...
    def test_none_json_request_body_validity_returns_none_json_request_body_message(self):
        ...
        actual_message = req.get_prediction_model_error_message_by_validity(PredictionRequestValidity.NONE_JSON_REQUEST_BODY)
    ...
    def test_missing_request_json_input_key_returns_missing_input_key_message(self):
        ...
        actual_message = req.get_prediction_model_error_message_by_validity(PredictionRequestValidity.MISSING_INPUT_KEY)
        assert actual_message == expected_message
    ...
    def test_none_request_json_input_key_returns_none_input_key_message(self):
        ...
        actual_message = req.get_prediction_model_error_message_by_validity(PredictionRequestValidity.NONE_INPUT_KEY)
        assert actual_message == expected_message
    ...
    def test_valid_input_to_error_message_returns_exception_message(self):
        ...
        with pytest.raises(ValueError, match=expected_message):
            req.get_prediction_model_error_message_by_validity(PredictionRequestValidity.VALID)

    def test_valid_validity_value_against_invalidity_check_returns_false(self):
        """
        Test if checking for an invalid status on a VALID PredictionRequestValidity input value
        returns False.
        """
        expected_check_result = False
        actual_check_result = req.is_invalid_request_json(PredictionRequestValidity.VALID)
    ...
    def test_none_json_request_body_validity_value_against_invalidity_check_returns_true(self):
        """
        Test if checking for an invalid status on a NONE_JSON_REQUEST_BODY PredictionRequestValidity input value
        returns True.
        """
        expected_check_result = True
        actual_check_result = req.is_invalid_request_json(PredictionRequestValidity.NONE_JSON_REQUEST_BODY)
        return actual_check_result == expected_check_result

    def test_missing_input_key_validity_value_against_invalidity_check_returns_true(self):
        """
        Test if checking for an invalid status on a MISSING_INPUT_KEY PredictionRequestValidity input value
        returns True.
        """
        expected_check_result = True
        actual_check_result = req.is_invalid_request_json(PredictionRequestValidity.MISSING_INPUT_KEY)
        return actual_check_result == expected_check_result

    def test_none_input_key_validity_value_against_invalidity_check_returns_true(self):
        """
        Test if checking for an invalid status on a NONE_INPUT_KEY PredictionRequestValidity input value
        returns True.
        """
        expected_check_result = True
        actual_check_result = req.is_invalid_request_json(PredictionRequestValidity.NONE_INPUT_KEY)
        return actual_check_result == expected_check_result

    def test_too_big_input_validity_value_against_invalidity_check_returns_true(self):
        """
        Test if checking for an invalid status on a TOO_BIG_INPUT PredictionRequestValidity input value
        returns True.
        """
        expected_check_result = True
        actual_check_result = req.is_invalid_request_json(PredictionRequestValidity.TOO_BIG_INPUT)
        return actual_check_result == expected_check_result